...
- **Скорости** — цветные сегменты ограничений скорости (зелёный ≥120, жёлтый ≥80, оранжевый ≥40, красный <40 км/ч)
- **Маршруты** — быстрый выбор предустановленных маршрутов (Абдулино-Кинель, Уфа-Челябинск)
...
3. Добавлять элементы через вкладки: Станции, Сигналы, Рельеф, Уклоны, Кривые, Рекомендации, Скорости
4. Выбрать маршрут из выпадающего списка для быстрой загрузки станций
5. Точки рельефа перетаскиваются мышью
6. Направление переключается кнопкой **«Развернуть»** (чётное/нечётное)
...
- [x] **Service Worker** — офлайн-работа, кэш, мгновенный старт
...
- [x] **PWA manifest** — установка как приложение на Android
